...
app.use((req, res, next) => {
    next(customError(404, `${req.originalUrl} The requested URL is not available!`));
})
...
app.listen(PORT, () => console.log(`${chalk.green.bold('Server Is Listing')} on ${chalk.white.bold(PORT)}`));